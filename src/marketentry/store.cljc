(ns marketentry.store
  "SSoT for the Grenada (GRD) market-entry compliance actor, behind a
  ...
  Procurement and Disposal of Public Property Act, 2014 s.17(1)(f)
  two-year lookback).
...
(defn demo-data
  ...
  `:director-conviction-date` / `:submission-date` are ground truth for
  the `director-conviction-disqualifying?` flagship check (s.17(1)(f)
  two-year lookback)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Spice Isle Construction Ltd" :portal "procurement.gov.gd"
             ...
             :jurisdiction "GRD" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "procurement.gov.gd"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :director-conviction-date nil :submission-date "2026-07-22"
             :requires-tin? true :tin-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Grenville Trading Co" :portal "procurement.gov.gd"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "GRD" :status :intake}
    "eng-4" {:id "eng-4" :operator "Carenage Export Ltd" :portal "procurement.gov.gd"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "GRD" :status :intake}
    "eng-5" {:id "eng-5" :operator "Grand Anse Logistics" :portal "procurement.gov.gd"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :director-conviction-date nil :submission-date "2026-07-22"
